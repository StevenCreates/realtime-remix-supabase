  ...
  return (
    ...
    <Header />
              ...
              <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                  ...
                  <p className="mt-6 max-w-lg mx-auto text-center text-xl text-zinc-200 sm:max-w-3xl">
                    Tools to take your live selling to the next level! With self/auto managed queue, and notifications
                    to let a user know they're up next or when you're live. Deeper insights to what times and products
                    do the best.
                  </p>
        ...
        <dl className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
          {features.map((feature) => (
            <div key={feature.name}>
              <dt>
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-white shadow text-violet-500">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-center text-base text-gray-400">&copy; 2022 zStorm Development, LLC. All rights reserved.</p>
      </div>
    </footer>
    </>
  );
